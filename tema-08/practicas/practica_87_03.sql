-- Active: 1777278242837@@127.0.0.1@3306@geslibros

-- Práctica 8.7 - Actividad Final
...
BEGIN
    ...
    SELECT
        ...
        stock_min,
        stock_max,
        (stock_max - stock) AS Stock_Necesario
...
BEGIN
    ...
    l_cursor: LOOP
        ...
        SET v_importe_bruto_funcion =
        importe_bruto_venta(v_id_venta);

        SET v_importe_iva_funcion =
        importe_iva_ventas(v_id_venta);

        SET v_importe_total_funcion =
        v_importe_bruto_funcion + v_importe_iva_funcion;
...
BEGIN
    ...
    INTO OUTFILE 'c:lineasventasdia.csv'
